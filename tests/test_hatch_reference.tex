...
\definecolor{green01280}{RGB}{0,128,0}
\definecolor{lightgrey204}{RGB}{204,204,204}
\definecolor{slateblue12776204}{RGB}{127,76,204}
\definecolor{steelblue31119180}{RGB}{31,119,180}
\definecolor{yellow2552550}{RGB}{255,255,0}
...
\draw[draw=black,fill=yellow2552550,postaction={pattern=horizontal lines}] (axis cs:0.6,0) rectangle (axis cs:1.4,1);
\draw[draw=black,fill=yellow2552550,postaction={pattern=grid}] (axis cs:1.6,0) rectangle (axis cs:2.4,2);
\draw[draw=black,fill=yellow2552550,postaction={pattern=crosshatch}] (axis cs:2.6,0) rectangle (axis cs:3.4,3);
\draw[draw=black,fill=yellow2552550,postaction={pattern=north west lines}] (axis cs:3.6,0) rectangle (axis cs:4.4,4);
\draw[draw=none,fill=green01280,postaction={pattern=fivepointed stars}] (axis cs:0.6,1) rectangle (axis cs:1.4,7);
\draw[draw=none,fill=green01280,postaction={pattern=sixpointed stars}] (axis cs:1.6,2) rectangle (axis cs:2.4,8);
\draw[draw=none,fill=green01280,postaction={pattern=bricks}] (axis cs:2.6,3) rectangle (axis cs:3.4,9);
\draw[draw=none,fill=green01280,postaction={pattern=crosshatch dots}] (axis cs:3.6,4) rectangle (axis cs:4.4,10);
